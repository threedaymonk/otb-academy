RSpec.describe "Objects in ruby" do
  ...
  it "has a fixed id when it is a small integer" do
    expect( 0.object_id ).to eq( 0.object_id )
    expect( 1.object_id ).to eq( 1.object_id )
    expect( 2.object_id ).to eq( 2.object_id )
    expect( 100.object_id ).to eq( 100.object_id)
    # expect( 10737418259000001073741825900000.object_id ).to eq( 10737418259000001073741825900000.object_id )
  end
